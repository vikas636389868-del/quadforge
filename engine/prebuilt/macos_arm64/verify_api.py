...
Usage:
    python3 QuadForge/engine/prebuilt/macos_arm64/verify_api.py
"""
...
def main() -> int:
    ...
    # ---- Load library ----
    print(f"\n=== QuadForge macos_arm64 API verification ===\n")
    ...
    if platform.machine() != "arm64":
        print(f"\n  WARNING: This library is built for arm64, running on {platform.machine()}")
        print(f"           Load may fail due to architecture mismatch.\n")
