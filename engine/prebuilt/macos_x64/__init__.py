"""
QuadForge prebuilt macos_x64 package.

Provides:
  libquadforge.dylib       — compiled native engine (Intel x86_64)
  ...
  libquadforge_macos_x64.c — C source for rebuilding from scratch
"""
